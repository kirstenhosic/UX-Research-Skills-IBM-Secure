...
2. **Tell Claude about your research:**
   ```
   I'm planning a migration study for Consul.
...
2. **Invoke the skill and tell Claude:**
   ```
   I need a research plan to inform our Consul migration strategy.
   ...
   We need findings by [DATE] for the launch event narrative.
   ```
...
- **Plan the narrative early** — What will you tell the launch event based on findings?
...
2. **Tell Claude:**
   ```
   We're planning a migration study for Consul. 
