...
| [`select_best_method.md`](select_best_method.md) | Scenario B, in full. Built around the Minimum Viable Research Method and your real recruitment constraints. | You need the most rigorous method you can actually run. |
