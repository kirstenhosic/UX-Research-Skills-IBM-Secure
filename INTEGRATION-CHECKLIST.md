...
cp skills/example-migration-research.json skills/example-boundary-feature-eval.json

# Consul adoption study
cp skills/example-migration-research.json skills/example-consul-adoption.json

# Terraform policy study
cp skills/example-migration-research.json skills/example-terraform-policies.json
```
...
```bash
cp skills/example-migration-research.json skills/example-[product].json
